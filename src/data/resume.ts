...
export const resume: ResumeData = {
  ...
  email: 'carson@cunderw.dev',
  linkedinProfile: 'https://www.linkedin.com/in/cunderw/',
  githubProfile: 'https://github.com/cunderw',
  aboutMe:
  ...
  experience: [
    ...
    },
    {
      ...
      otherRoles: ['Game Designer', 'Level Scripter', 'QA Tester', 'Audio Engineer'],
      duties: [
